...
class SuperDelegateLocationEventsTests: SuperDelegateTests {
    ...
    func test_applicationDidFinishLaunching_notifiesAboutLocationEvent() {
        ...
        XCTAssertTrue(locationEventsCapableDelegate.application(UIApplication.shared, didFinishLaunchingWithOptions: [UIApplication.LaunchOptionsKey.location : true]))
    ...
    func test_applicationWillFinishLaunching_doesNotNotifyAboutLocationEvent() {
        let locationEventsCapableDelegate = LocationEventsCapableDelegate()
        XCTAssertTrue(locationEventsCapableDelegate.application(UIApplication.shared, willFinishLaunchingWithOptions: [UIApplication.LaunchOptionsKey.location : true]))
